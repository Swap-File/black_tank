...
void ArduinoNunchuk::reinit()
{
  ...
  delay(10);
  ArduinoNunchuk::_sendByte(0xA5, 0x00);
  delay(10);
...
void ArduinoNunchuk::update()
{
  ...
  if(ArduinoNunchuk::official== false) {
    ArduinoNunchuk::_sendByte(0x52, 0x00);
  }
  ...
  ArduinoNunchuk::analogAngle = (atan2((int)ArduinoNunchuk::analogYcenter-(int)ArduinoNunchuk::analogY,(int)ArduinoNunchuk::analogXcenter-(int)ArduinoNunchuk::analogX)*57.2957);
